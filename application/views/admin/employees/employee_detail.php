...
<?php $deducton_matrices = $this->Payroll_model->get_deduction_matrices(); ?>
                    ...
                    <div class="tab-pane fade" id="account-statutory_deductions">
                      ...
                      <div class="card-body pb-2">
                        ...
                        <div class="row">
                          <div class="col d-none">
                            <div class="form-group">
                              ...
                              <select name="statutory_options" class="form-control" data-plugin="select_hrm">
                                <option value="0" selected><?php echo $this->lang->line('xin_title_tax_fixed'); ?></option>
                                <option value="1"><?php echo $this->lang->line('xin_title_tax_percent'); ?></option>
                              </select>
                            </div>
                          </div>
                          ...
                          <div class="col">
                            <div class="form-group">
                              <label for="statutory_type"><?php echo $this->lang->line('xin_deduction_type'); ?><i class="hrsale-asterisk">*</i></label>
                              <select name="title" class="form-control" id="statutory_type" data-plugin="select_hrm">
                          ...
                          <div class="col">
                            <div class="form-group">
                              <label for="pay_range"><?php echo $this->lang->line('xin_salary_pay_range'); ?><i class="hrsale-asterisk">*</i></label>
                              <select name="amount" class="form-control" id="pay_range" data-plugin="select_hrm">

                                <?php
                                foreach ($deducton_matrices as $deduction) { ?>
                                  <option value="<?php echo $deduction->charge; ?>"><?php echo $deduction->pay_range; ?></option>
                                <?php }
                                ?>
