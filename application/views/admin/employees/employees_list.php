        ...
        <div class="col-md mb-3" id="designation_ajaxflt">
          <div class="form-group">
            ...
            <select class="form-control" name="employment_type" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('xin_employment_type'); ?>">
              <option value="Temporary"><?php echo $this->lang->line('xin_employment_temporary'); ?></option>
              <option value="Contract"><?php echo $this->lang->line('xin_employment_contract'); ?></option>
              <option value="Permanent"><?php echo $this->lang->line('xin_employment_permanent'); ?></option>
            </select>
          </div>
        </div>
        ...
        <table class="datatables-demo table table-striped table-bordered" id="xin_table">
          <thead>
            <tr>
              ...
              <th><?php echo $this->lang->line('xin_employment_type'); ?></th>
