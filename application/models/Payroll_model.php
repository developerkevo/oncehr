<?php
	...
	public function get_payslips_for_p9($user_id, $date_from, $date_2)
	{
		$sql = 'SELECT salary_month, basic_salary,total_allowances,total_commissions,total_other_payments FROM xin_salary_payslips WHERE employee_id = ? AND created_at BETWEEN ? AND ? ';
		$binds = array($user_id,$date_from, $date_2);
		$query = $this->db->query($sql, $binds);
		return $query->result();
	}
	...
	public function get_company_payslip_history($company_id,$salary_month) {
