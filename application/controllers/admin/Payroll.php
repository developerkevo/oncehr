...
class Payroll extends MY_Controller
{
	...
	public function add_deduction_matrix()
	{
		...
		if ($id == "" or $id == null) {
			...
			if ($this->Payroll_model->add_deduction_matrix($data)) {
				redirect('admin/payroll/generate_payslip');
			}
		} else {
			if ($this->Payroll_model->update_deduction_matrix($data, $id)) {
				redirect('admin/payroll/generate_payslip');
			}
		}
	}

	public function delete_deduction_matrix()
	{
		$id = $this->uri->segment(4);
		if ($this->Payroll_model->delete_deduction_matrix($id)) {
			redirect('admin/payroll/generate_payslip');
		}
	}
