...
<div class="ui-bordered px-4 pt-4 mb-4">
	<?php $attributes = array('name' => 'generate_nssf', 'id' => 'generate_nssf', 'class' => 'm-b-1 add form-hrm', "method"=>"post");?>
	<?php $hidden = array('user_id' => $session['user_id']);?>
	<?php echo form_open('admin/payroll/nssf_nhif_report', $attributes, $hidden);?>
	<div class="form-row">

		<div class="col-md-3 mb-4" id="type">
			<label class="form-label"><?php echo $this->lang->line('xin_type');?></label>
			<select id="type" name="type" class="form-control" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('xin_choose_type');?>">

					<option value="<?php echo $this->lang->line('xin_nhif');?>"> <?php echo $this->lang->line('xin_nhif') ?></option>
					<option value="<?php echo $this->lang->line('xin_nssf');?>"> <?php echo $this->lang->line('xin_nssf') ?></option>

			</select>
		</div>
		<?php if($user_info[0]->user_role_id==1 || in_array('314',$role_resources_ids)){ ?>
			<div class="col-md-3 mb-4" id="employee_ajax">
